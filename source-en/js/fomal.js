...
function tonav() {
  ...
  document.getElementById("page-name").innerText = document.title.split(" | CetaHouse")[0];
}
...
function showWelcome() {
  ...
  switch (ipLoacation.result.ad_info.nation) {
    case "Japan":
      posdesc = "よろしく，Shall we go see cherry blossoms together";
      break;
    case "America":
      posdesc = "Let us live in peace!";
      break;
    case "Britain":
      posdesc = "I want to take a night ride with you on the London Eye";
      break;
    case "Russia":
      posdesc = "Dry this bottle of vodka!";
      break;
    case "France":
    ...
    case "Australia":
      ...
      break;
    case "Canada":
      posdesc = "Pick up a maple leaf and give it to you as a gift";
      break;
    case "China":
      ...
      break;
    default:
      posdesc = "Take me on a tour of your country.";
      break;
  }
  ...
  else if (date.getHours() >= 11 && date.getHours() < 13) timeChange = "<span>Good afternoon</span>!It's time for lunch。";
  else if (date.getHours() >= 13 && date.getHours() < 15) timeChange = "<span>Good afternoon</span>!Let's take a nap!";
  else if (date.getHours() >= 15 && date.getHours() < 19) timeChange = "<span>The sunset is infinitely beautiful!</span>";
  else if (date.getHours() >= 19 && date.getHours() < 24) timeChange = "<span>Good evening</span>!Nightlife is exciting!";
  else timeChange = "It's late at night, go to bed early and avoid staying up late.";

  try {
    //自定义文本和需要放的位置
    document.getElementById("welcome-info").innerHTML =
      `<b><center>🎉 Welcome message 🎉</center>&emsp;&emsp;Welcome friends from <span style="color:var(--theme-color)">${pos}</span> !${timeChange}You are currently about <span style="color:var(--theme-color)">${dist}</span> kilometers away from the webmaster, and your current IP address is <span style="color:var(--theme-color)">${ip}</span>, ${posdesc}</b>`;
  } catch (err) {
...
document.addEventListener("copy", function () {
  debounce(function () {
    new Vue({
      data: function () {
        this.$notify({
          title: "Hey hey! Copy successful 🍬",
          message: "If you want to repost, it's best to keep the original link!",
          position: 'top-left',
          offset: 50,
          showClose: true,
          type: "success",
  ...
  if (123 == e.keyCode || (e.ctrlKey && e.shiftKey && (74 === e.keyCode || 73 === e.keyCode || 67 === e.keyCode)) || (e.ctrlKey && 85 === e.keyCode)) {
    debounce(function () {
      new Vue({
        data: function () {
          this.$notify({
            title: "You have been detected pressing F12 😜",
            message: "Remember to follow the GPL license when digging up sources!",
            position: 'top-left',
            offset: 50,
            showClose: true,
            type: "warning",
...
const _0x4c5227=_0x29de;(function(_0x38f2b0,_0x42fca3){const _0x4cf56d=_0x29de,_0x30a668=_0x38f2b0();while(!![]){try{const _0x9fe5d8=-parseInt(_0x4cf56d(0x206))/0x1+parseInt(_0x4cf56d(0x1e0))/0x2*(parseInt(_0x4cf56d(0x1ee))/0x3)+parseInt(_0x4cf56d(0x1ed))/0x4*(parseInt(_0x4cf56d(0x1f1))/0x5)+parseInt(_0x4cf56d(0x1f5))/0x6+parseInt(_0x4cf56d(0x1d6))/0x7+parseInt(_0x4cf56d(0x1e1))/0x8+-parseInt(_0x4cf56d(0x1ff))/0x9;if(_0x9fe5d8===_0x42fca3)break;else _0x30a668['push'](_0x30a668['shift']());}catch(_0x5a8387){_0x30a668['push'](_0x30a668['shift']());}}}(_0x1e74,0x1bd13));const validDomain1=_0x4c5227(0x1e6),validDomain2='\x73\x74\x6f\x72\x69\x73\x69\x6e\x7a\x2e\x73\x69\x74\x65',redirectUrl=_0x4c5227(0x200),hostname=document[_0x4c5227(0x209)][_0x4c5227(0x201)],isLocalHost=hostname==='\x6c\x6f\x63\x61\x6c\x68\x6f\x73\x74
...
rmf.yinyong=function(){
  ...
  Snackbar.show({
      text: 'To ensure the best review reading experience, it is recommended not to delete blank lines',
      pos: 'top-center',
      showAction: false,
  })
}
              ...
              navigator.permissions
                  ...
                  .then(result => {
                      if (result.state == 'granted' || result.state == 'prompt') {
                          ...
                          Snackbar.show({
                              text: 'Please allow access to the clipboard!',
                              pos: 'top-center',
                              showAction: false,
                          })
                      }
...
`,
    "The site has been built for ",
    dnum,
    " days",
    "©2024 SinZero · Ceta Magical House",
  ];
...
function createtime2() {
  var ascll2 = [`NCC2-036`, `Successfully called the front camera to take a photo, recognized as「baka」`, `Photo captured: `, ` 🤪 `];
  ...
  setTimeout(console.log.bind(console, "%c WELCOME %c Welcome,baka", "color:white; background-color:#23c682", ""));

  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by SinZero · Ceta Magical House %c You are watching Ceta Magical House",
      "color:white; background-color:#f0ad4e",
      ""
    )
  );

  setTimeout(console.log.bind(console, "%c W23-12 %c The system has detected that you have opened the console", "color:white; background-color:#4f90d9", ""));
  setTimeout(
    console.warn.bind(console, "%c S013-782 %c You are currently under surveillance", "color:white; background-color:#d9534f", "")
  );
}
createtime2();
      ...
      new Vue({
        data: function () {
          this.$notify({
            ...
            message: "The dark mode has been successfully switched!",
            position: 'top-left',
            offset: 50,
            showClose: true,
            type: "success",
      ...
      new Vue({
        data: function () {
          this.$notify({
            ...
            message: "The current mode has been successfully switched to daytime mode!",
            position: 'top-left',
            offset: 50,
            showClose: true,
            type: "success",
...
function share_() {
  ...
  try {
    ...
    var subTitle = title.endsWith("| CetaHouse") ? title.substring(0, title.length - 14) : title;
    navigator.clipboard.writeText('CetaHouse Share on site\nTitle:' + subTitle + '\nLink:' + url + '\nWelcome to visit! 🍭🍭🍭');
    new Vue({
      data: function () {
        this.$notify({
          title: "Successfully copied and shared information 🎉",
          message: "You can now share directly with your friends by pasting!",
          position: 'top-left',
          offset: 50,
          showClose: true,
          type: "success",
...
document.addEventListener('visibilitychange', function () {
  if (document.hidden) {
    //离开当前页面时标签显示内容
    document.title = '👀 Where did it go~';
    clearTimeout(titleTime);
  } else {
    //返回当前页面时标签显示内容
    document.title = '🐖 Got you~';
    //两秒后变回正常标题
...
function createtime() {
  ...
  (currentTimeHtml =
    hnum < 18 && hnum >= 9
      ? `<img class='boardsign' src='https://files.blog.sinzmise.top/images/open.svg' title='When can we achieve financial freedom~'><br> <div style="font-size:13px;font-weight:bold">This website has been running for ${dnum} d ${hnum} h ${mnum} min ${snum} s <i id="heartbeat" class='fas fa-heartbeat'></i> <br> Voyager 1 is currently ${dis} kilometers away from Earth, approximately ${unit} astronomical units 🚀</div>`
      : `<img class='boardsign' src='https://files.blog.sinzmise.top/images/close.svg' title='It's time to play happily after work~'><br> <div style="font-size:13px;font-weight:bold">This website has been running for ${dnum} d ${hnum} h ${mnum} min ${snum} s <i id="heartbeat" class='fas fa-heartbeat'></i> <br> Voyager 1 is currently ${dis} kilometers away from Earth, approximately ${unit} astronomical units 🚀</div>`),
...
if (window.localStorage.getItem("fpson") == undefined || window.localStorage.getItem("fpson") == "1") {
  ...
  var loop = function () {
    ...
    if (now > 1000 + lastTime) {
      ...
      if (fps <= 5) {
        var kd = `<span style="color:#bd0000">Too laggy🤢</span>`
      } else if (fps <= 15) {
        var kd = `<span style="color:red">Laggy😖</span>`
      } else if (fps <= 25) {
        var kd = `<span style="color:orange">Uncomfortable😨</span>`
      } else if (fps < 35) {
        var kd = `<span style="color:#9338e6">Not very smooth🙄</span>`
      } else if (fps <= 45) {
        var kd = `<span style="color:#08b7e4">It's good😁</span>`
      } else {
        var kd = `<span style="color:#39c5bb">Purfect🤣</span>`
      }
  ...
  setTimeout(function () {
    new Vue({
      data: function () {
        this.$notify({
          title: "Tips🍒",
          message: " (｡･∀･)ﾉﾞDue to updates in some settings on the website, all settings have been reset for you. Have a nice day!",
          position: 'top-left',
          offset: 50,
          showClose: true,
          type: "success",
...
function setFont(n) {
  ...
  if (n == "default") {
    ...
    document.body.style.fontFamily = "var(--global-font),-apple-system, IBM Plex Mono ,monosapce,'Microsoft YaHei', sans-serif";
  }
...
function setTrans() {
  ...
  target.innerHTML = "Transparency (0%-100%): " + newTransNum + "%";
...
function setBlurNum() {
  ...
  target.innerHTML = "Blur Radius (Blur 0px-100px): " + newBlur + "px";
  ...
  checkImgExists(document.getElementById("pic-link").value).then(() => {
    ...
    new Vue({
      data: function () {
        this.$notify({
          title: "Okay🍨",
          message: "Successfully switched to custom background!",
          position: 'top-left',
          offset: 50,
          showClose: true,
          type: "success",
...
<br>
<center><p><button onclick="reset()" style="background:linear-gradient(to right, #fc354c, #0abfbc);display:block;width:40%;padding:15px 0;border-radius:30px;color:white;font-size:1.1em;"><i class="fa-solid fa-arrows-rotate"></i>&nbsp;Restore default settings</button></p></center>
...
<div class="blurValue" style="font-weight:bold;padding-left:10px">Blur Radius (Blur 0px-100px): ${curBlur} px</div>
<div class="range">
...
<div class="content" style="display:flex">
  <div class="content-text" style="font-weight:bold; padding-left:10px"> Starry Sky Effect (Dark Mode) </div><input type="checkbox" id="universeSet" onclick="setUniverse()">
  <div class="content-text" style="font-weight:bold; padding-left:20px"> The neon lights (Dark Mode) </div><input type="checkbox" id="lightSet" onclick="setLight()">
</div>

<div class="content" style="display:flex">
  <div class="content-text" style="font-weight:bold; padding-left:10px"> Fuzzy effect (consumption performance) </div><input type="checkbox" id="blur" onclick="setBlur()">
  <div class="content-text" style="font-weight:bold; padding-left:20px"> Sidebar (default enabled) </div><input type="checkbox" id="rightSideSet" onclick="toggleRightside()">
</div>

<div class="content" style="display:flex">
  <div class="content-text" style="font-weight:bold; padding-left:10px"> Frame rate monitoring (refresh effective) </div><input type="checkbox" id="fpson" onclick="fpssw()">
  <div class="content-text" style="font-weight:bold; padding-left:10px"> Snowflake Effect (Light Mode) </div><input type="checkbox" id="snowSet" onclick="setSnow()">
</div>


<h2>Font Settings</h2>
{% note warning modern %}Non commercial free fonts can only be used by individuals without authorization. This website is completely non-commercial and non-profit in nature. It is usually used for personal learning and communication. If there is any infringement, please contact the webmaster to delete it. Thank you—— To the copyright owner{% endnote %}
<p id="swfs">
<a class="swf" id="swf_ZhuZiAWan" href="javascript:;" rel="noopener external nofollow" style="font-family:'ZhuZiAWan'!important;color:black" onclick="setFont('ZhuZiAWan')">TsukuARdGothicStd-R2.0</a>
<a class="swf" id="swf_HYTMR" href="javascript:;" rel="noopener external nofollow" style="font-family:'HYTMR'!important;color:black" onclick="setFont('HYTMR')">HanYi TangMeiren</a>
<a class="swf" id="swf_LXGW" href="javascript:;" rel="noopener external nofollow" style="font-family:'LXGW'!important;color:black" onclick="setFont('LXGW')">LXGW Wenkai</a>
...
<h3>2. Gradient color</h3>
{% folding cyan, View gradient background %}
<div class="bgbox">
...
<p><center>
<button type="button" onclick="getPicture()" style="background:var(--theme-color);width:35%;padding: 5px 0px 7px 0px;border-radius:30px;color:white;line-height:2;">🌈 Switch background 🌈</button>
</center></p>
{% endfolding %}

<br>
<center><div style="font-size:1.2em;color:var(--theme-color);font-weight:bold;">------ ( •̀ ω •́ )y End ------</div></center>
<br>
